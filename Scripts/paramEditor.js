namespace paramEditor
{
	...
	{	
		...
		//GUI
		const var zone = ui.panel(440, 0, {width:200, height:225, id:"peRightZone", paintRoutine:paintRoutines.zone, parentComponent:tab.getPanelId(tabs[0])}); //Outer panel
		const var lblTitle = ui.label(0, 0, {width:200, height:25, text:"Controllers", textColour:Theme.H1.colour, fontName:Theme.H1.font, fontSize:Theme.H1.fontSize, alignment:"centred", parentComponent:"peRightZone"});

		const var lblParam = ui.label(5, 42, {width:85, height:25, text:"Parameter", fontName:Theme.H2.font, textColour:Theme.H2.colour, fontSize:Theme.H2.fontSize, alignment:"topLeft", parentComponent:"peRightZone"});
		const var lblCc = ui.label(5, 77, {width:85, height:25, text:"Controller",  fontName:Theme.H2.font, textColour:Theme.H2.colour, fontSize:Theme.H2.fontSize, alignment:"topLeft", parentComponent:"peRightZone"});
		const var lblValue = ui.label(5, 112, {width:85, height:25, text:"Value",  fontName:Theme.H2.font, textColour:Theme.H2.colour, fontSize:Theme.H2.fontSize, alignment:"topLeft", parentComponent:"peRightZone"});
		...
		const var responseBg = ui.panel(10, 147, {width:180, height:70, paintRoutine:function(g){g.fillAll(Theme.TABLE.bg);}, parentComponent:"peRightZone"}); //Background for tables
		...
		for (p in PARAMETERS.LABELS)
		{
			...
			sliValue.push(ui.knob(90, 112, {width:100, height:25, style:"Horizontal", min:0, max:127, visible:false, bgColour:Theme.SLIDER.bg, itemColour:Theme.SLIDER.fg, itemColour2:0, textColour:0, parentComponent:"peRightZone"}));
